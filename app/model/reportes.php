...
//REPORTE DE TURNOS
$TurnosCount = DevolverUnDato("select count(*) from auditoria where Estado = 'TERMINADO' or Estado = 'AUSENTE' and auditoria.FechaLlegada >= '2018/01/01 00:00:00' and auditoria.FechaLlegada<='2018/12/31 23:59:59'");
$TurnosAtendidosCount = DevolverUnDato("select count(*) from auditoria where Estado = 'TERMINADO' and auditoria.FechaLlegada >= '2018/01/01 00:00:00' and auditoria.FechaLlegada<='2018/12/31 23:59:59'");
$TurnosAusentesCount = DevolverUnDato("select count(*) from auditoria where Estado = 'AUSENTE' and auditoria.FechaLlegada >= '2018/01/01 00:00:00' and auditoria.FechaLlegada<='2018/12/31 23:59:59'");
...
$servicios = DevolverUnArreglo("select servicio.Servicio, COUNT(auditoria.IdServicio) as Cantidad from auditoria JOIN servicio on (auditoria.IdServicio = servicio.IdServicio) where Estado = 'TERMINADO' or Estado = 'AUSENTE' and auditoria.FechaLlegada >= '2018/01/01 00:00:00' and auditoria.FechaLlegada<='2018/12/31 23:59:59' GROUP by auditoria.IdServicio");
$ServiciosCount = DevolverUnDato("select count(*) from auditoria where Estado = 'TERMINADO' or Estado = 'AUSENTE' and auditoria.FechaLlegada >= '2018/01/01 00:00:00' and auditoria.FechaLlegada<='2018/12/31 23:59:59'");
$totalPorcentaje = 0;
...
$Poblacion = DevolverUnArreglo("select servicio.Servicio, COUNT(auditoria.IdServicio) as Cantidad from auditoria JOIN servicio on (auditoria.IdServicio = servicio.IdServicio) where Estado = 'TERMINADO' or Estado = 'AUSENTE' and auditoria.FechaLlegada >= '2018/01/01 00:00:00' and auditoria.FechaLlegada<='2018/12/31 23:59:59' GROUP by auditoria.IdServicio");
...
$objPHPExcel->getActiveSheet()->setCellValue("A" . $contar, "IDAUDITORIA");
...
$objPHPExcel->getActiveSheet()->setCellValue("H" . $contar, "TIEMPO DE ESPERA EN SALA");
$objPHPExcel->getActiveSheet()->setCellValue("I" . $contar, "TIEMPO DE ATENCION");
$objPHPExcel->getActiveSheet()->setCellValue("J" . $contar, "TIEMPO TOTAL");
